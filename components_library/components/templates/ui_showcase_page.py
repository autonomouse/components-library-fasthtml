        ...
        vstack(
            ...
            vstack(
                ...
                _showcase_card(
                    "Icons",
                    vstack(
                        text("Generic Usage (icon atom):", variant="caption"),
                        hstack(
                            icon("home", size="sm"),
                            icon("settings", size="md"),
                            icon("heart", size="lg", color="red"),
                            gap=3,
                        ),
                        separator(),
                        text("Specific Icon Atoms:", variant="caption"),
                        grid(
                            hstack(plus_icon(), text("plus_icon")),
                            hstack(edit_icon(), text("edit_icon")),
                            hstack(trash_icon(), text("trash_icon")),
                            hstack(check_icon(), text("check_icon")),
                            hstack(close_icon(), text("close_icon")),
                            hstack(search_icon(), text("search_icon")),
                            hstack(file_text_icon(), text("file_text_icon")),
                            hstack(map_pin_icon(), text("map_pin_icon")),
                            hstack(book_open_icon(), text("book_open_icon")),
                            hstack(user_icon(), text("user_icon")),
                            columns=2,
                            gap="1rem",
                        ),
                        separator(),
                        text("Stateful Icons:", variant="caption"),
                        hstack(
                            checkbox_icon(checked=False),
                            checkbox_icon(checked=True),
                            eye_icon(off=False),
                            eye_icon(off=True),
                            star_icon(),
                            gap=3,
